...
// CONCATENATED MODULE: ./src/components/Document/Document.jsx
...
class Document_MyDocument extends document_default.a {
  static async getInitialProps(ctx) {
    ...
    try {
      ...
      return _objectSpread({}, initialProps, {
        styles: __jsx(external_react_default.a.Fragment, null, initialProps.styles, sheet.getStyleElement())
      });
    } finally {
      sheet.seal();
    }
  ...
  render() {
    return __jsx("html", null, __jsx(next_document["Head"], null, __jsx("meta", {
      name: "viewport",
      content: "initial-scale=1.0, width=device-width"
    }), this.props.styleTags), __jsx("body", null, __jsx(next_document["Main"], null), __jsx(next_document["NextScript"], null)));
  }

}
// CONCATENATED MODULE: ./pages/_document.js
/* concated harmony reexport default */__webpack_require__.d(__webpack_exports__, "default", function() { return Document_MyDocument; });
